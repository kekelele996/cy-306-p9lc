...
const (
	...
	NotificationWaitlistJoined   = "waitlist_joined"
	NotificationWaitlistPromoted = "waitlist_promoted"
)

// NotificationTypeValues 全部通知类型值。
var NotificationTypeValues = []string{NotificationSignupSuccess, NotificationReminder, NotificationReviewResult, NotificationCheckinSuccess, NotificationWaitlistJoined, NotificationWaitlistPromoted}
